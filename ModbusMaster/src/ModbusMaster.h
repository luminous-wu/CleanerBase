...
class ModbusMaster
{
  public:
    ...
    */
    ...
    void send(uint16_t);
    void send(uint32_t);
    void setSubIndex(uint8_t);
    uint8_t available(void);
    uint16_t receive(void);
    
    uint8_t  setMotorSpeeds();
    uint8_t  setVelocity(uint8_t* data, uint8_t* u8ModbusADU);
    uint8_t  readCoils(uint16_t, uint16_t);
    uint8_t  readDiscreteInputs(uint16_t, uint16_t);
    uint8_t  readHoldingRegisters(uint16_t, uint16_t, uint8_t*);
    uint8_t  readInputRegisters(uint16_t, uint8_t, uint8_t*);
    uint8_t  writeSingleCoil(uint16_t, uint8_t);
    uint8_t  writeSingleRegister(uint16_t, uint16_t, uint8_t*);
    uint8_t  writeMultipleCoils(uint16_t, uint16_t);
    uint8_t  writeMultipleCoils();
    uint8_t  writeMultipleRegisters(uint16_t, uint16_t, uint8_t*);
